...
ActiveRecord::Schema.define(version: 20150327142052) do
  ...
  add_index "pujas", ["product_id"], name: "index_pujas_on_product_id", using: :btree
  add_index "pujas", ["user_id"], name: "index_pujas_on_user_id", using: :btree
